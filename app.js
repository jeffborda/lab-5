...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  var productElement = multiply(multiply(a, b)[0], c)[0];
  var sumMessage = a + ' and ' + b + ' and ' + c + ' sum to ' + sumElement + '.';
  var productMessage = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + productElement + '.';
  return [sumElement, productElement, sumMessage, productMessage];
}
...
function sumArray(sumArr) { //eslint-disable-line
  ...
  var message = sumArr + ' was passed in as an array of numbers, and ' + output + ' is their sum.';
  return [output, message];
...
function multiplyArray(multArr) { //eslint-disable-line
  ...
  var message = 'The numbers ' + multArr + ' have a product of ' + output + '.';
  return [output, message];
}
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
  var output = dynamicArray[0];
  for(var i = 1; i < dynamicArray.length; i++){
    output = multiply(output, dynamicArray[i])[0];
  }
  var message = 'The numbers ' + dynamicArray + ' have a product of ' + output + '.';
  return [output, message];
}
